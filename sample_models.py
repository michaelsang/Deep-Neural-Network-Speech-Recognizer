...
def rnn_model(input_dim, units, activation, output_dim=29):
    ...
    #CAN TRY CHANGING FROM GRU TO LSTM??
...
def cnn_rnn_model(input_dim, filters, kernel_size, conv_stride,
    ...
    #removed implementation argument since it is deprecated from SimpleRNN
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        if i:
            simp_rnn = GRU(units, return_sequences=True,implementation=2)(simp_rnn)
        else:
            simp_rnn = GRU(units, return_sequences=True,implementation=2)(input_data)
...
#def final_model(input_dim, recur_layers, units, output_dim=29):
    ...
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
    time_dense = TimeDistributed(Dense(output_dim))(bn_bidir_deep_rnn)    
